...
foreach ($id in $subs) {
  ...
  $anomalies = Detect-CostAnomalies -NovData $nov -DecData $dec -RecentActivityDays $RecentActivityDays -SignificantChangeThreshold $SignificantChangeThreshold -MinimumCostThreshold $MinimumCostThreshold
